...
namespace FileDocument.DataAccess.Migrations
{
    ...
    [Migration("20230612094455_ChangeFlightTableAndDocumentTable")]
    partial class ChangeFlightTableAndDocumentTable
    {
            ...
            modelBuilder.Entity("FileDocument.Models.Entities.Flight", b =>
                {
                    ...
                    b.Property<bool>("FlightEnd")
                        .HasColumnType("bit");

                    b.Property<bool>("IsDocumentReported")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("FileDocument.Models.Entities.Flight", b =>
                {
                    ...
                    b.HasOne("FileDocument.Models.Entities.Airport", "Airport1")
                        .WithMany()
                        .HasForeignKey("SourceAirporttId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("Aircraft");

                    b.Navigation("Airport1");

                    b.Navigation("Airport2");
                });
